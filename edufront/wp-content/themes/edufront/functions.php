...
function twentyfourteen_scripts() {
	...
	// Load the Inter net Explorer specific stylesheet.
...
function my_walker_nav_menu_start_el($item_output, $item, $depth, $args) {
    ...
    if ( $depth == 1 ) {
        $item_output = preg_replace('/<a /', '<a class="font-menu activeedu" ', $item_output, 1);
    } else if ( $depth == 2 ) {
        $item_output = preg_replace('/<a /', '<a class="font-menu activeprod" ', $item_output, 1);
    
    } else if( $depth == 3 ) {
        $item_output = preg_replace('/<a /', '<a class="font-menu activecontact" ', $item_output, 1);
    }
