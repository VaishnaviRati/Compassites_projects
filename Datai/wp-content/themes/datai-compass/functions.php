	...
	function twentyfourteen_setup() {
		...
		register_nav_menus(
			array(
				...
				'header-menu' => __( 'Header Menu' , 'datai-compass' ),
				'footer-menu-1' => __( 'Footer Menu 1', 'datai-compass' ),
				'footer-menu-2' => __( 'Footer Menu 2','datai-compass' ),
				'footer-menu-3' => __( 'Footer Menu 3', 'datai-compass' ),
				'footer-menu-4' => __( 'Footer Menu 4', 'datai-compass' ),				
			)
		);
