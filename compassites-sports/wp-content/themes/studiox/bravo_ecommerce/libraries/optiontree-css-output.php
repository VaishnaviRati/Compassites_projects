 ...
 * Time: 9:39 AM
 */
if(!class_exists('BravoCustomCSSOutput'))
{

    class BravoCustomCSSOutput
    {
        static function _init()
        {
			...
			add_action('wp_enqueue_scripts',array(__CLASS__,'add_custom_css'));
		...
		{
			wp_add_inline_style('studiox-style',self::_get_custom_css());
		}
