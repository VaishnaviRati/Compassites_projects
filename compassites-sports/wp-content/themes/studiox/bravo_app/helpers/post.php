    ...
    function bravo_paging($query=false,$key='paged',$link=false)
    {
        ...
        <div class="pagination-full">
            <?php if($page>1){
                ...
                printf('<a class="pagination-prev" href="%s">%s</a>',esc_url($prev),esc_html__('Previous Page',"studiox"));
            }?>
            ...
            <?php if($page<$query->max_num_pages and $next=get_next_posts_page_link()){
                ...
                printf('<a class="pagination-next" href="%s">%s</a>',esc_url($next),esc_html__('Next Page',"studiox"));
            }?>
        </div>
...
if(!function_exists('bravo_default_thumbnail'))
{
    ...
    {
        $alt=esc_html__('Image Alt',"studiox");
...
if(!function_exists('bravo_get_list_taxonomy'))
{
    function bravo_get_list_taxonomy($tax,$array=array())
    {
        ...
        $r[esc_html__('All Categories',"studiox")]="_0_";
